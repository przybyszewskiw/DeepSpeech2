...
\makebox[\linewidth]{%        to center the image
		...
		\begin{axis}[
		  ...
		  \addplot table[x=epochs,y=training]{\bn};
			\addlegendentry{training}		  
		  \addplot table[x=epochs,y=validation]{\bn};
			\addlegendentry{validation}
		  

		\end{axis}
		\end{tikzpicture}
		}\captionof{figure}{Batch norm plot}\label{dsad}		     
\end{minipage}
...
\makebox[\linewidth]{%        to center the image
		...
		\begin{axis}[
		  ...
		  \addplot table[x=epochs,y=training]{\dropouticm};
			\addlegendentry{training without dropout}		  
		  \addplot table[x=epochs,y=validation]{\dropouticm};
			\addlegendentry{validation without dropout}
		  \addplot table[x=epochs,y=training]{\amp};
			\addlegendentry{normal training}		  
		  \addplot table[x=epochs,y=validation]{\amp};
