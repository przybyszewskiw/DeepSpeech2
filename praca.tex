...
$$
	...
	\end{cases*}
$$
Recurrent layers appear in a few different variants - standard recurrent layers or Long Short-Term Memory (LSTM) or Gated Recurrent Units (GRU). After the recurrent layers and fully connected layers are applied, we count the output layer $L$ as a softmax of the output of the last layer. TODO Opisać o co chodzi z softmaxem\\\\

\section{CTC Loss}
TODO opisać co robi CTC loss\\\\
